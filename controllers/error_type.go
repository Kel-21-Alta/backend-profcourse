...
var JAWABAN_QUIZ_EMPTY = errors.New("Jawaban quis tidak boleh kosong")
var PERTANYAAN_QUIZ_EMPTY = errors.New("Pertanyaan quis tidak boleh kosong")
var PILIHAN_QUIZ_EMPTY = errors.New("Pilihan quiz tidak boleh kosong")
var PILIHAN_QUIZ_MINUS = errors.New("Pilihan quiz kurang dari 2 pilihan")
var ID_QUIZ_EMPTY = errors.New("Id quis tidak boleh kosong")
var PROGRESS_EMPTY = errors.New("Tidak terdapat progress")
var LAST_MATERI_EMPTY = errors.New("Last materi tidak boleh kosong")
var LAST_MODUL_EMPTY = errors.New("Last modul tidak boleh kosong")
var RATING_EMPTY = errors.New("Rating tidak boleh kosong")
var REVIEW_EMPTY = errors.New("Review tidak boleh kosong")
var FEEDBACK_EMPTY = errors.New("Feedback tidak boleh kosong")
var REQUEST_EMPTY = errors.New("Request tidak boleh kosong")
var CATEGORY_EMPTY = errors.New("Category request tidak boleh kosong")
var ID_REQUEST_USER = errors.New("id request user kosong")
var ALREADY_REGISTERED_SPESIALIZATION = errors.New("User telah tedaftar di spesialization")
var SPESIALIZATION_ID_EMPTY = errors.New("Spesialisasi tidak boleh kosong")
var ALREADY_DELETE = errors.New("Sudah dihapus")