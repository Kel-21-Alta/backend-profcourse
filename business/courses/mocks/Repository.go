...
// DeleteCourseForAdmin provides a mock function with given fields: ctx, id
func (_m *Repository) DeleteCourseForAdmin(ctx context.Context, id string) (courses.Domain, error) {
...
// DeleteCourseForUser provides a mock function with given fields: ctx, id, token
func (_m *Repository) DeleteCourseForUser(ctx context.Context, id string, token courses.Token) (courses.Domain, error) {
...
// UpdateCourseForAdmin provides a mock function with given fields: ctx, domain
func (_m *Repository) UpdateCourseForAdmin(ctx context.Context, domain *courses.Domain) (courses.Domain, error) {
	ret := _m.Called(ctx, domain)
...
// UpdateCourseForUser provides a mock function with given fields: ctx, domain, token
func (_m *Repository) UpdateCourseForUser(ctx context.Context, domain *courses.Domain, token *courses.Token) (courses.Domain, error) {
