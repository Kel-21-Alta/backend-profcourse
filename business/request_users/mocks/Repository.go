...
// AdminGetAllRequestUser provides a mock function with given fields: ctx, domain
func (_m *Repository) AdminGetAllRequestUser(ctx context.Context, domain *request_users.Domain) ([]request_users.Domain, error) {
